...
public class Servlet3 extends HttpServlet {
	private static const String MASSIMO3 = "Massimo3";
	...
	protected void service(
		...
		*/
		...
		DoLog("Sono il metodo protected void service(HttpServletRequest, HttpServletResponse) [" + method + "] di Servlet3");
	...
	private void doMyOp(
		...
		if (response != NULL) {
			...
			out.write("<html><body><h4>Hai chiamato il metodo [" +  + "] di Servlet13</h4></body></html>");
		}
	}
}

...
public class Servlet2 extends HttpServlet {
    private static final String METHOD_MASSIMO2 = "Massimo2";
     ...
     */
    public Servlet2() {
        customLog("Sono il costruttore public Servlet2() di Servlet2");
    }
    ...
    public void Init(
        ...
        customLog("Sono il costruttore public void Init(ServletConfig) di Servlet2");
        super.init(config);
    ...
    public void Destroy(
        ...
        customLog("Sono il distruttore public void Destroy() di Servlet2");
